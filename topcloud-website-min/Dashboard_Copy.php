 ...
 <form method ="post">
          ...
          <div class="messenger-card-top-bar">
            ...
            <div class="messages-container" id="messages-container">
              <div class="closed-messenger-division" id="messenger-division1">
                <div class="messenger-division-top-bar" onclick="toggleMessengerDivisionExpansion('1')">
                  <div class="left-container">
                    <div class="closed-drop-button" id="drop-button1"></div>
                    <h2>Professors</h2>
                  </div>
                  <div class="invisible-notification-badge" id="notification-badge1">
                    <p id="notification-number1"></p>
                  </div>
                </div>
                <div class="closed-messenger-content" id="content1">
              ...
              <div class="closed-messenger-division" id="messenger-division2">
                <div class="messenger-division-top-bar" onclick="toggleMessengerDivisionExpansion('2')">
                  <div class="left-container">
                    <div class="closed-drop-button" id="drop-button2">
                    </div>
                    <h2>Classmates</h2>
                  </div>
                  <div class="invisible-notification-badge" id="notification-badge2">
                    <p id="notification-number2"></p>
                  </div>
                </div>
<!-- Display Messages function -->
              <div class="closed-messenger-content" id="content2">
                <div class="message-container">
                  <div class="message-title">
<?php
...
// $getMes = $getMes->fetch_array(MYSQLI_BOTH);
 //$rowMes = $message-> fetch_array(MYSQLI_BOTH);
if($getMes -> num_rows >0)
{
	while($rowMes = $getMes -> fetch_assoc()){
	...
	$getFandLName = $getOriginaID -> fetch_array(MYSQLI_BOTH);
		...
		echo "From: ",$getFandLName['FName']," ",$getFandLName['LName'], " ", $rowMes['mesTime'],
		"<br>",
		"Title: ",$rowMes['mesTitle']," ",
		"<br>","Contents: ",
		$rowMes['contents'],
		"<br>";
		echo "<br>";
